...
- ilia ran an earlier rwa platform (smartlands/definder), left voluntarily in early 2022
  before a controversial token dilution event. if asked, state it plainly, don't get
  defensive, don't relitigate. then move on. keep it short and calm like everything else.
